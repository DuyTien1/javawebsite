...
<c:url var="APInewurl" value="/api-admin-new"/>
<c:url var="APIcategoryurl" value="/api-admin-category"/>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <c:if test="${not empty messageResponse}">
                        <div class="center alert alert-${alert}">${messageResponse}</div>
                    </c:if>
                        <form id="formSubmit" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right">Thể loại</label>
                                <div class="col-sm-10">
                            ...
                            <br/><br/><br/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right">Tiêu đề</label>
                                <div class="col-sm-10">
                            ...
                            <br/><br/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right">Hình đại diện</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control dropify" id="thumbnail" name="thumbnail" value=""/>
                                </div>
                            </div>
                            <br/><br/>
                            <div class="form-group">
    ...
    function addNew(data) {
        $.ajax({
            ...
            error: function (error) {
                window.location.href = "${NewURL}?type=list&maxPageItem=2&page=1&message=system_error";
            }
        });
    }
